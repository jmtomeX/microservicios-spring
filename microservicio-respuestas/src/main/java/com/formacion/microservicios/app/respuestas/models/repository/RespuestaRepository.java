...
public interface RespuestaRepository extends MongoRepository<Respuesta, String> {
	...
	//obtener respuestas de un alumno y para un examen en particular, que se va a buscar al examen por api rest
	// buscar en la colección respuestas el alumnoId y por un conjunto de preguntas que se encuentren dentro del conjunto

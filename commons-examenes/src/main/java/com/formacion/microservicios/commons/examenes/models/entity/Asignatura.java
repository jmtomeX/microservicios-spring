...
public class Asignatura {
	...
	// asignaturas padres e hijas, (self join) asignatura referenciada hacia si misma
	// "handler" evitar errores en las relaciones bidireccionales
	// "hibernateLazyInitializer" solo cuando se utiliza el método Get
